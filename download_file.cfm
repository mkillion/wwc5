...
<cfset Columns = "WELL_ID,COUNTY,TOWNSHIP,TWN_DIR,RANGE,RANGE_DIR,SECTION,SPOT,LONGITUDE,LATITUDE,LONG_LAT_TYPE,OWNER,WELL_USE,COMPLE_DATE,STATUS,OTHER_ID,DWR_NUMBER,DIRECTIONS,WELL_DEPTH,ELEV,STATIC_DEPTH,EST_YIELD,DRILLER">
